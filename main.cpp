...
void list_run()
{
    ...
    out << "|                                        Check list<int>                                                 |\n";
    out << "|========================================================================================================|\n";
    std::cout << std::endl << CYAN << "CHECK list" << RED << "<int>" << RESET << std::endl;
    list_start<int>(&out);
    out << "|========================================================================================================|\n\n";
    ...
    out << "|                                        Check list<char>                                                |\n";
    out << "|========================================================================================================|\n";
    std::cout << std::endl << CYAN << "CHECK list" << RED << "<char>" << RESET << std::endl;
    list_start<char>(&out);
    out << "|========================================================================================================|\n\n";
    ...
    out << "|========================================================================================================|\n";
    std::cout << std::endl << CYAN << "CHECK list" << RED << "<double>" << RESET << std::endl;
    ...
    out << "|========================================================================================================|\n";
    std::cout << std::endl << CYAN << "CHECK list" << RED << "<float>" << RESET << std::endl;
    ...
    out << "|========================================================================================================|\n";
    std::cout << std::endl << CYAN << "CHECK list" << RED << "<std::string>" << RESET << std::endl;
